          ...
          {clients.map((client) => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 bg-slate-900/95 dark:bg-slate-950/95 p-3 flex justify-around items-center translate-y-full group-hover:translate-y-0 transition-transform duration-200" onClick={(e) => e.stopPropagation()}>
                  <button
