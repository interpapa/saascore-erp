...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative flex items-center justify-center w-10 h-10 rounded-xl bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-400 hover:text-foreground transition-all btn-haptic group"
