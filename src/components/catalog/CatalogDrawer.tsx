                ...
                <div className="bg-red-500/10 border border-red-500/20 rounded-2xl p-4 space-y-3 animate-in fade-in duration-200">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="flex-1 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 py-2 rounded-xl text-xs font-bold transition-all btn-haptic flex items-center justify-center"
                    >
                      Cancelar
                    </button>
                  </div>
